...
## 使用方法
````
wget -N --no-check-certificate https://raw.githubusercontent.com/supersongssr/Shadowsowcks1Click/master/Shadowsowcks1Click.sh;chmod +x Shadowsowcks1Click.sh;./Shadowsowcks1Click.sh
````
<br>复制上方代码并执行开始安装。
## 脚本功能
````
